        ...
        {#snippet child({ props })}
            <Button
                ...
                class={cn(
                    ...
                    // Radius: Round Left/Flat Right in LTR -> Flat Left/Round Right in RTL
                    'rounded-l-lg rounded-r-none rtl:rounded-l-none rtl:rounded-r-lg',
                    disabled ? 'opacity-50' : ''
                )}
                {disabled}
            >
                ...
                <ChevronsUpDownIcon
                    class={cn(
                        'h-4 w-4 opacity-50',
                        // Margin: Pull Right in LTR -> Pull Left in RTL
